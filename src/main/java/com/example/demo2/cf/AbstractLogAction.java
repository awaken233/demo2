...
//                throwable instanceof TBase || (throwable.getCause() != null && throwable
//                    .getCause() instanceof TBase);
//            if (isBusinessError) {
//                logBusinessError(throwable);
//            } else if (throwable instanceof DegradeException
//                || throwable instanceof DegradeRuntimeException) {//这里为内部rpc框架抛出的异常，使用时可以酌情修改
//                if (RhinoSwitch.getBoolean("isPrintDegradeLog", false)) {
//                    log.error("{} degrade exception, param:{} , error:{}", methodName, args,
//                        throwable);
//                }
//            } else {
